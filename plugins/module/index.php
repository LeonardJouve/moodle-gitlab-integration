...
$event = \mod_gitlab\event\course_module_instance_list_viewed::create([
    'context' => $modulecontext,
]);
$event->add_record_snapshot('course', $course);
$event->trigger();

$PAGE->set_url('/mod/gitlab/index.php', ['id' => $id]);
...
$modulenameplural = get_string('modulenameplural', 'mod_gitlab');
