...
$string['form_due_date_past_err'] = 'Due date must be in the future.';
...
$string['modal_delete_group_confirm'] = 'Confirm';
$string['modal_delete_group_help'] = 'Do you really want to delete this group ?';
