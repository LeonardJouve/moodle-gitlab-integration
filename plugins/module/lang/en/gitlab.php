...
$string['template_student_group_instructions'] = 'Instructions';
...
$string['template_teacher_group_instructions'] = 'Instructions';
...
$string['template_teacher_template_release_solution'] = 'Release solution';
...
$string['notification_graded_title'] = 'Assignment graded in {$a->name}';
$string['notification_graded_description'] = 'The activity {$a->name} in course {$a->course} has been graded.';
...
$string['webhook_name'] = 'Moodle webhook';
$string['commit_create_ci_file'] = 'Create ci file';
...
$string['modal_delete_group_help'] = 'Are you sure you want to delete this group ?<br>Enter the following to confirm:<br><strong>{$a->name}</strong>';
$string['modal_delete_group_field'] = 'Confirmation';
$string['modal_delete_group_mismatch'] = 'The entered name does not match the group name.';
